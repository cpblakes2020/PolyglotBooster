...
import { analyze, speak, type AnalysisOptions } from "@/components/anki/api";
...
// learning-language audio straight away.
export function ItemEditor({ item, language, seenIn, match, options, onDone }: ItemEditorProps) {
  ...
  return (
    <div className="anki-item-editor">
      ...
      <div className="anki-card-preview" dangerouslySetInnerHTML={{ __html: preview }} />
